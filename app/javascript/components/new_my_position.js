...
const newMyPosition = () => {
    ...
    const symbol = document.querySelector("#select_my_stock_id")
    const jquery_symbol = $('#select_my_stock_id')
    // const quantity = document.querySelector("#position_quantity_1")
    const entry = document.querySelector("#my_position_current_price")
    if (symbol) {
